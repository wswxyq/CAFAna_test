...
void GEANT_MCNP_numuE_true(){


  const std::string subdir = "subdir_TrueE_spectra";

  //TFile inFile_GEANT("../20-10-07/results/100000__/spectra.root");
  //TFile inFile_MCNP("MCNP_LSTM/results/100000/spectra.root");

  TFile * inFile_GEANT = new TFile("GEANT_true/results/100000/spectra.root", "read");
  TFile * inFile_MCNP = new TFile("MCNP_true/results/100000/spectra.root", "read");
  ...
  canvas_0->Print("./pdf/GEANT_MCNP_true.pdf");
