...
map<int, string> pdg_latex = {
    {111, "#pi^{0}"}, {211, "#pi^{+/-}"}, {2212, "p"}, {2112, "n"}, {11, "e"}, {13, "#mu"}, {15, "#tau"}, {-13, "all but #mu"}};
...
void table_muE_fun(int mode_val, int pdg_val, string filename)
{
    ...
    outfile << (mode_map[mode_val] + "_" + pdg_map[input_pdg]).c_str() << "\t\t"
...
void table_numuE_fun(int mode_val, int pdg_val, string filename)
{
...
void test()
{
    table_muE_fun(100000, -13, "muE.txt");
    table_numuE_fun(100000, -13, "numuE.txt");
}