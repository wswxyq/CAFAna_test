...
int input_FSI = -9999;
double shift_pm = 1.0;
// bool var that determine whether positive or negative shift is used.
// by default we choose positive.


void exec_FSI_with_resolution(int mode_val, int FSI_val, double p_m) {
    ...
    Spectrum LSTM_resolution_spectra("LSTM_resolution_spectra", bins, loader, LSTM_resolution, cut, shift_2020);
    Spectrum Standard_resolution_spectra("Standard_resolution_spectra", bins, loader, Standard_resolution, cut, shift_2020);
