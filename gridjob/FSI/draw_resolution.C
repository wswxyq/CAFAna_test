...
void draw_resolution_select_fun(int mode_val, int input_FSI)
{
    ...
    logfile << "+1 sigma mean:" << TH1D_modified_up->GetMean() << "  " << std::setprecision(3) << 100. * (TH1D_modified_up->GetMean() - TH1D_original->GetMean()) / TH1D_original->GetMean() << "%" << endl;
    logfile << "-1 sigma mean:" << TH1D_modified_down->GetMean() << "  " << std::setprecision(3) << 100. * (TH1D_modified_down->GetMean() - TH1D_original->GetMean()) / TH1D_original->GetMean() << "%" << endl;
    logfile << "Original(Green) RMS:" << TH1D_original->GetRMS() << endl;
    logfile << "+1 sigma mean:" << TH1D_modified_up->GetRMS() << "  " << std::setprecision(3) << 100. * (TH1D_modified_up->GetRMS() - TH1D_original->GetRMS()) / TH1D_original->GetRMS() << "%" << endl;
    logfile << "-1 sigma mean:" << TH1D_modified_down->GetRMS() << "  " << std::setprecision(3) << 100. * (TH1D_modified_down->GetRMS() - TH1D_original->GetRMS()) / TH1D_original->GetRMS() << "%" << endl;
    logfile << endl;
    logfile.close();
    delete canvas_0;
}
