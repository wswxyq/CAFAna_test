    ...
    public:
      ...
      void Shift(double sigma, caf::SRProxy* sr, double& weight) const override
      {
        ...
        for (size_t i = 0; i < png2d.size(); i++) {
          if (png2d[i].truth.pdg==input_pdg)
          {
...
void prong_length_adjust_down_select()
{
  ...
  TFile *outFile = new TFile(("/nova/ana/users/wus/root_files/FD_FHC_spectra_sys5_x_0_10_down_"+pdg_map[input_pdg]+".root").c_str(),"RECREATE");
