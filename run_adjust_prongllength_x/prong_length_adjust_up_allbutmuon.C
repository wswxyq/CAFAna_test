...
void prong_length_adjust_up_allbutmuon()
{
  ...
  TFile *outFile = new TFile(("/nova/ana/users/wus/root_files/new/FD_FHC_spectra_sys5_x_0_10_up_allbutmuon"+pdg_map[input_pdg]+".root").c_str(),"RECREATE");
